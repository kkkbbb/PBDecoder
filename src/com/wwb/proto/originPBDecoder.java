...
class oringinPBDecoder {
    ...
    public static void dumpProtoBuffNew(String info, Object[] argObjects) {
        final boolean isProto3 = getSyntax(info) == 3;

        System.out.println("isProto3: " + isProto3);
        ...
        while (i < length) {
            ...
            if (fieldType >= ONEOF_TYPE_OFFSET) {
                ...
                System.out.println("{oneOfField oneofFieldType=" + pbTypeToString(oneofFieldType) + ", oneofField="
